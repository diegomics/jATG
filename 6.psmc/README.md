...
OPTIONAL: if you want to re-run the PSMC with different parameters (`PARAMS`) and/or time intervals values, edit accordingly `1.psmc_variables.cnf` and run: `bash OPTIONAL_rePSMC.sh`
