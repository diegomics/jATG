...
nr_windows	<- 10			# minimum number of adjacent windows to be considered as a ROH (for example: if n_windows is set 5, and window size is 100000, then reported ROHs are minimum 500Kb)
missmax		<- 0.8
